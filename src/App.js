...
const paymentAmount = contract.amount / numPayments;
    ...
    const contractHTML = `
      <div style="font-family: Arial, sans-serif; max-width: 800px; margin: 0 auto; padding: 16px; line-height: 1.38; font-size: 10.5px; page-break-after: always;">
        <div style="background: linear-gradient(135deg, #1a4d1a 0%, #2d5a27 100%); color: white; padding: 11px 12px; border-radius: 8px; text-align: center; margin-bottom: 10px;">
...
<div style="margin-bottom: 9px;">
  <h3 style="color: #1a4d1a; font-size: 12px; margin-bottom: 5px; font-weight: bold; border-bottom: 2px solid #1a4d1a; padding-bottom: 3px;">Détails du Service :</h3>
  ${contract.entreesCompletes ? `<p style="margin: 5px 0;"><strong>• Entrée(s) complète(s) :</strong> ${contract.entreesCompletes}</p>` : ''}
  ${contract.instructionsEntrees ? `<p style="margin: 4px 0; margin-left: 20px; font-style: italic; color: #495057;">↳ ${contract.instructionsEntrees}</p>` : ''}
  ${contract.devantsTempo ? `<p style="margin: 5px 0;"><strong>• Devant(s) seulement (tempo) :</strong> ${contract.devantsTempo}</p>` : ''}
  ${contract.instructionsTempo ? `<p style="margin: 4px 0; margin-left: 20px; font-style: italic; color: #495057;">↳ ${contract.instructionsTempo}</p>` : ''}
  ...
  ${contract.instructionsCommercial ? `<p style="margin: 4px 0; margin-left: 20px; font-style: italic; color: #495057;">↳ ${contract.instructionsCommercial}</p>` : ''}
</div>
` : ''}
        <hr style="border: 1px solid #a8c5a8; margin: 7px 0;">
        
        <div style="margin-bottom: 9px;">
          <h3 style="color: #1a4d1a; font-size: 12px; margin-bottom: 5px; font-weight: bold; border-bottom: 2px solid #1a4d1a; padding-bottom: 3px;">Conditions Générales du Service :</h3>
...
<p style="margin: Xpx 0;"><strong>4. Déplacement des Véhicules :</strong> Après une tempête de neige, nous passons une première fois pour dégager un chemin qui vous permet de sortir de votre entrée. Veuillez ensuite sortir votre/vos véhicule(s) de l'entrée avant 9h00 AM le lendemain matin, car c'est à ce moment que nous repassons pour compléter le déneigement au complet.</p>
...
<p style="margin: Xpx 0 Xpx 20px;">Initiales du client : ______</p>
        ...
        <hr style="border: 1px solid #a8c5a8; margin: 7px 0;">
        <div style="margin-bottom: 9px;">
          <h3 style="color: #1a4d1a; font-size: 12px; margin-bottom: 5px; font-weight: bold; border-bottom: 2px solid #1a4d1a; padding-bottom: 3px;">Notes Spéciales :</h3>
          <div style="background: #f8f9fa; border: 1px solid #dee2e6; border-radius: 8px; padding: 8px; margin: 5px 0;">
        ...
        <div style="margin-bottom: 9px;">
          <h3 style="color: #1a4d1a; font-size: 12px; margin-bottom: 5px; font-weight: bold; border-bottom: 2px solid #1a4d1a; padding-bottom: 3px;">Période de Validité :</h3>
        ...
        <div style="margin-bottom: 9px;">
          <h3 style="color: #1a4d1a; font-size: 12px; margin-bottom: 5px; font-weight: bold; border-bottom: 2px solid #1a4d1a; padding-bottom: 3px;">Modalités de Tarification et de Paiement :</h3>
...
` : `
  ...
  <div style="margin: 5px 0;">
    ...
    <p style="margin: 4px 0; margin-left: 20px;">• Date : ${client.secondPaymentDate || 'À déterminer'}</p>
    <p style="margin: 4px 0; margin-left: 20px;">• Montant : ${paymentAmount.toFixed(2)} $</p>
  </div>
  ...
  ${(paymentStructure === '3' || paymentStructure === '4') ? `
    ...
    <div style="margin: 5px 0;">
      ...
      <p style="margin: 4px 0; margin-left: 20px;">• Date : ${client.thirdPaymentDate || 'À déterminer'}</p>
      <p style="margin: 4px 0; margin-left: 20px;">• Montant : ${paymentAmount.toFixed(2)} $</p>
    </div>
  ` : ''}
  ...
  ${paymentStructure === '4' ? `
    ...
    <div style="margin: 5px 0;">
      ...
      <p style="margin: 4px 0; margin-left: 20px;">• Date : ${client.fourthPaymentDate || 'À déterminer'}</p>
      <p style="margin: 4px 0; margin-left: 20px;">• Montant : ${paymentAmount.toFixed(2)} $</p>
    </div>
  ` : ''}
`}
        ...
        <div style="margin-bottom: 9px;">
          <h3 style="color: #1a4d1a; font-size: 12px; margin-bottom: 5px; font-weight: bold; border-bottom: 2px solid #1a4d1a; padding-bottom: 3px;">Acceptation du Contrat :</h3>
          <p style="margin: Xpx 0;">En signant ci-dessous, le client et le représentant de JM Pominville reconnaissent avoir lu, compris et accepté l'intégralité des clauses et conditions énoncées dans le présent contrat.</p>
<p style="margin: Xpx 0; font-weight: bold;">⚠️ Vos initiales sont requises aux 4 endroits indiqués ci-dessus (clauses 4 et 6), en plus de votre signature ci-dessous.</p>

        </div>
        
        <div style="margin-top: 13px; display: table; width: 100%; table-layout: fixed;">
          <div style="display: table-cell; width: 48%; vertical-align: top;">
            <p style="margin: 2px 0; font-weight: bold;">Signature du Client :</p>
            <hr style="border: none; border-top: 1px solid #000; margin: 13px 0;">
