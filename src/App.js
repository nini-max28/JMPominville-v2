...
const paymentAmount = contract.amount / numPayments;
    ...
    const contractHTML = `
      <div style="font-family: Arial, sans-serif; max-width: 800px; margin: 0 auto; padding: 14px; line-height: 1.32; font-size: 10.5px; page-break-after: always;">
        <div style="background: linear-gradient(135deg, #1a4d1a 0%, #2d5a27 100%); color: white; padding: 9px 12px; border-radius: 8px; text-align: center; margin-bottom: 7px;">
...
<hr style="border: 1px solid #a8c5a8; margin: 5px 0;">
<div style="margin-bottom: 6px;">
...
` : ''}
        ...
        <div style="margin-bottom: 6px;">
          ...
          <div style="background: #f8f9fa; border: 1px solid #dee2e6; border-radius: 8px; padding: 7px; margin: 4px 0;">
