...
const printMultipleContracts = () => {
  ...
  selectedContracts.forEach((contractId, index) => {
    ...
    // Utilise le même template que generateContract
    const contractHTML = `
