...
<div style="margin-bottom: 25px;">
  <h3 style="color: #000; font-size: 14px; margin-bottom: 15px; font-weight: bold;">Détails du Service :</h3>
...
`}
        ...
        <div style="margin-top: 40px; display: flex; justify-content: space-between;">
          ...
          <div style="width: 45%;">
            ...
            <div style="margin: 20px 0; height: 60px; width: 150px; overflow: hidden; display: flex; align-items: center; justify-content: flex-start;">
